...
const BigArticleCard = ({article}) => {
    ...
    if(article && article.topic === 'coding') {
        ...
        return(
            <div className='col-span-3  pt-3 h-38 max-h-38 min-h-38'>
                <Link href={`/article/${article.article_id}`}>
                    <div className=' h-full w-full grid grid-cols-3 bg-guard-topictile-pink hover:bg-guard-topictile-hover-pink'>
                            <div className=' col-span-1 h-full border-t-[1px] border-guard-topictext-pink'>
                                {/* text */}
                                <div className='h-full px-2'>
                                    {article &&
        ...
        return(
            <div className='col-span-3  pt-3 h-38 max-h-38 min-h-38'>
                <Link href={`/article/${article.article_id}`}>
                    <div className=' h-full w-full grid grid-cols-3 bg-guard-topictile-beige hover:bg-guard-topictile-hover-beige'>
                            <div className=' col-span-1 h-full border-t-[1px] border-guard-topictext-beige'>
                                {/* text */}
                                <div className='h-full px-2'>
                                    {article &&
