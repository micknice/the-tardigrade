...
const SmallArticleCard = ({article}) => {
    ...
    if (article && article.topic === 'coding') {
        ...
        return (
            <div className=' pt-1 h-full w-full '>
                <Link href={`/article/${article.article_id}`}>
                    <div className='col-span-1 border-t-[1px] border-guard-topictext-beige h-full  bg-guard-topictile-beige hover:bg-guard-topictile-hover-beige grid grid-rows-4'>
                        {article &&
